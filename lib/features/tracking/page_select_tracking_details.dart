...
class PageSelectBusTrackingDetails extends StatefulWidget{
  static const String routeName = '/page_select_bus_tracking_details';
  PageSelectBusTrackingDetails({super.key});

  @override
  State<PageSelectBusTrackingDetails> createState() => _PageSelectBusTrackingDetails();
}

class _PageSelectBusTrackingDetails extends State<PageSelectBusTrackingDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
        ...
        child: Scaffold(
          appBar: AppBar(
            title: Text(AppStrings.busTracingDetails),
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            ButtonWidget(
              size: size,
              buttonText: AppStrings.search,
              onTap: (){
                Navigator.pushNamed(context, Routes.busTrackingMapPage);
              },
            ),
          ],
        ),
